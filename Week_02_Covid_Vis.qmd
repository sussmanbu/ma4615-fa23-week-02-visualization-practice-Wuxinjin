...
I am not able to calculate the percentage of cases vs total population in the dataset,
it is very important to see the percentage of the population getting covid since the population of different state is different, directly comparing them can't tell much information.

4. What other data would be useful to better understand this data?
The total population of each race and the percentage of population of each race. Since the total population of each race is different, it is hard to compare the degree of infection of covid-19 on each race just by analyzing the total cases for each race.